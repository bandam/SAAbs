...
public class PaintUML {
     ...
     */
    public void convertToConcernDetectorPlantUMLClassDiagrm(String xmiFile, int UML_XMI_Sel, ArrayList<String> ClassInfo) throws
            IOException, InterruptedException {
        ...
        //source += "skinparam class ATM classFontSize 32 \n";
        source += xmiReader.readConcernDetectorClassDiagram();
        tempStr += rReader.getRelationshipMatrices();
        source += tempStr;
    ...
    public void convertToConcernDetectorPlantUMLPackageDiagrm(String xmiFile, int UML_XMI_Sel, ArrayList<String> ClassInfo) throws
            IOException, InterruptedException {
        ...
        source += xmiReader.readConcernDetectorPackDiagram();
        tempStr += rReader.getConcernDetectorRelationshipMatrices();
        source += tempStr;
    ...
    public void convertToConcernDetectorPlantUMLSlider(String plantUMLScript,
            List<String> allClass, int maxPosInt, int displayType) throws IOException, InterruptedException {
        // TODO code application logic here
        ByteArrayOutputStream bous = new ByteArrayOutputStream();
        String path = getClass().getClassLoader().getResource(".").getPath();
