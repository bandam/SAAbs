 ...
 * @author aislimau
 */
public class TextExtractor1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        csvFileName.setText("C:\\Users\\aisli_000\\Dropbox\\MyShare\\TextMining\\RverseDesigner\\build\\classes\\Book1001.csv");
    ...
    private void extractTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extractTextActionPerformed
        ...
        String metaModelURL = "metamodel2.xml";//sdmetrics";  // metamodel definition to use
	String xmiTransURL = "xmiTrans2_0.xml";   // XMI tranformations to use
    ...
    private void readCSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_readCSVActionPerformed
        ...
        try {
            ...
            while ((row = csvReader.readNext()) != null){
                ...
                classListLocal.add(row[1].substring(lastDotIndex));
...
//        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TextExtractor1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TextExtractor1().setVisible(true);
            }
        });
    }
