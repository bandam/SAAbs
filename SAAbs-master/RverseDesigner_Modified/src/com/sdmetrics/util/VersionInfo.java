...
public class VersionInfo {
	...
	public final static String PROPERTIES_FILE = ".SDMetrics2.3.props";
	/** The previous files that stored the application properties. */
	final static String[] oldVersions = { ".SDMetricsDemo2.3.props",
	...
	public final static String VERSION_NUMBER = "V2.3";
	/** Program name+version. */
	public final static String VERSION = "SDMetrics " + VERSION_NUMBER;
	/** Copyright string, using unicode characters. */
	public final static String COPYRIGHT = "\u00a9 2002-2012 by J\u00FCrgen W\u00FCst";
	/** Copyright string, using only ASCII characters. */
	public final static String COPYRIGHTASCII = "(c) 2002-2012 by Juergen Wuest";
}
