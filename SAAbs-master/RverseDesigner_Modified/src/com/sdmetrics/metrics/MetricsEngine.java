...
public class MetricsEngine {
	...
	class MetricValuesCache {
		/** Metric value cache. */
		private HashMap<ModelElement, Object[]> metricValues = new HashMap<ModelElement, Object[]>();
		/** Set value cache. */
		private HashMap<ModelElement, Collection<?>[]> setValues = new HashMap<ModelElement, Collection<?>[]>();
